...
function ReplyButton({ parentPostInfo, commentData, onCommentSubmit }: { parentPostInfo: PostProperties, commentData?: CommentProperties, onCommentSubmit: (newComment: CommentProperties) => void }) {
